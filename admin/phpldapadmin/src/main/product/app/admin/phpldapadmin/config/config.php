...
$config->custom->commands['cmd'] = array(
	'entry_internal_attributes_show' => false,
	'entry_refresh' => true,
	'oslinks' => true,
...
$servers->setValue('server','name','@{product.name}');
...
$servers->setValue('server','port',@{ldap.port});

/* Array of base DNs of your LDAP server. Leave this blank to have phpLDAPadmin
   auto-detect it for you. */
// $servers->setValue('server','base',array(''));
$servers->setValue('server','base',array('@{ldap.base.dn}'));
...
$servers->setValue('login','bind_id','@{ldap.root.dn}');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
// $servers->setValue('login','bind_pass','');
$servers->setValue('login','bind_pass','%{LDAP_ROOT_PASSWORD}');
...
$servers->setValue('login','attr','@{ldap.user.rdn.attr}');

/* Base DNs to used for logins. If this value is not set, then the LDAP server
   Base DNs are used. */
$servers->setValue('login','base',array('@{ldap.users.dn}'));
...
/* If 'login,attr' is used above such that phpLDAPadmin will search for your DN
   ...
   setup. */
$servers->setValue('login','class',array('@{ldap.user.class}'));
