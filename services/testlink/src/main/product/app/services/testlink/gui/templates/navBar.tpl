...
<body style="min-width: 800px;" id="navbar-body">
<div style="float:left; height: 100%;" id="logo">
...
<div class="menu_title">
  ...
  <span>[ <a href='lib/usermanagement/userInfo.php' target="mainframe" accesskey="i"
   ...
   |  <a href="{$gui->logout}" target="_parent" accesskey="q">{$labels.link_logout}</a> ]
  </span>
...
{/if}
{$session.testprojectTopMenu|replace:' | ':''}
