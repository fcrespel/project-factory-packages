...
MIDDLEWARE_CLASSES = [
    ...
    'forum.middleware.login_required.LoginRequiredMiddleware', # F. CRESPEL EDIT 2013-01-22: added custom middleware to enforce login
    ...
    'forum.middleware.response_utils.ResponseUtilsMiddleware', # F. CRESPEL EDIT 2013-01-28: added custom middleware to allow overriding the response
