...
working_directory "@{package.app}" # available in 0.94.0+

# Listen on both a Unix domain socket and a TCP port.
# If you are load-balancing multiple Unicorn masters, lower the backlog
# setting to e.g. 64 for faster failover.
listen "@{package.app}/tmp/sockets/gitlab.socket", :backlog => 1024
listen "@{gitlab.unicorn.bind}:@{gitlab.unicorn.port.http}", :tcp_nopush => true
...
pid "@{package.app}/tmp/pids/unicorn.pid"

# By default, the Unicorn logger will write to stderr.
# Additionally, some applications/frameworks log to stderr or stdout,
# so prevent them from going to /dev/null when daemonized here:
stderr_path "@{package.app}/log/unicorn.stderr.log"
stdout_path "@{package.app}/log/unicorn.stdout.log"
...
require_relative "@{package.app}/lib/gitlab/cluster/lifecycle_events"
